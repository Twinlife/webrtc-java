...
public class SQLiteDatabase extends SQLiteClosable /* implements
     ...
     */
    /* package */ final Map<String, SQLiteCompiledSql> mCompiledQueries = new HashMap<String, SQLiteCompiledSql>();
    /**
     * @hide
     */
     ...
     */
    private final boolean mLockingEnabled = true;
    ...
    public static SQLiteDatabase openDatabase(String path, byte[] password, CursorFactory factory, int flags,
        ...
        DatabaseErrorHandler myErrorHandler = errorHandler;
    ...
    private void closeClosable() {
        ...
        for (Map.Entry<SQLiteClosable, Object> entry : mPrograms.entrySet()) {
    ...
    public Cursor rawQuery(String sql, Object[] args) {
        ...
        Cursor cursor = driver.query(mFactory, args);
