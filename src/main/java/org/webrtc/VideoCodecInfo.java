...
public class VideoCodecInfo {
  ...
  //@Deprecated public final int payload; // --twinlife 2025-01-31: remove deprecated code

  @CalledByNative
  public VideoCodecInfo(String name, Map<String, String> params) {
    //this.payload = 0; // --twinlife 2025-01-31: remove deprecated code
    this.name = name;
    this.params = params;
  }
  ...
  public VideoCodecInfo(int payload, String name, Map<String, String> params) {
    //this.payload = payload; // --twinlife 2025-01-31: remove deprecated code
    this.name = name;
    this.params = params;
  }
